...
printf "\nFor your reference important commands that are executed will appear in "; print_code "code format"; printf "For example:\n"
print_code_pass -c "echo \"Hello Apache Kafka\""
...
(docker-compose up -d connect | tee -a $LOG_FILE) \
...
printf "Confluent Cloud KSQL is running and accruing charges. To destroy this demo run and verify ->\n"
